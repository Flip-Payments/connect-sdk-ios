...
@interface NSLocale (SWIFT_EXTENSION(FlipConnectSDK))
@end


SWIFT_CLASS("_TtC14FlipConnectSDK16TemporaryProfile")
@interface TemporaryProfile : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface UICollectionView (SWIFT_EXTENSION(FlipConnectSDK))
@end


@interface UITableView (SWIFT_EXTENSION(FlipConnectSDK))
@end


@interface UIView (SWIFT_EXTENSION(FlipConnectSDK))
@end


@interface UIViewController (SWIFT_EXTENSION(FlipConnectSDK))
@end
